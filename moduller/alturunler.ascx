<%@ control language="C#" autoeventwireup="true" inherits="moduller_alturunler, App_Web_vuke25lm" %>
<%@ Register Assembly="CollectionPager" Namespace="SiteUtils" TagPrefix="cc1" %>
<div class="center_title_bar"><asp:Label ID="Label1" runat="server" Text=""></asp:Label> Alt Kategorine Ait Markalar</div>
<table>
    <tr>
        <td class="ince">
    ...
    <tr>
        <td class="ince">
        <img src="../images/favs.gif" /><a href="Default.aspx?ad=markalar&id=<%#Eval("MarkID") %>"><%#Eval("MarkaAd") %></a>
        </td></tr></table>
            </ItemTemplate>
        </asp:DataList>
        </td>
...
<div class="center_title_bar"><asp:Label ID="lblbaslik" runat="server" Text="Label"></asp:Label> Alt Kategorine Ait Ürümler</div>
    ...
    <ItemTemplate>
        <div class="prod_box">
            ...
            <a href="Default.aspx?ad=urundetay&id=<%#Eval("UrunID")%>">
                <img src="../urunresimleri/<%#Eval("Resim1") %>" style="with: 150px; height: 120px; border: 0;" /></a></div>
