<%@ control language="C#" autoeventwireup="true" inherits="moduller_anaurunler, App_Web_vuke25lm" %>
<%@ Register Assembly="CollectionPager" Namespace="SiteUtils" TagPrefix="cc1" %>

<div class="center_title_bar"><asp:Label ID="lblbaslik" runat="server" Text="Label"></asp:Label> Ana Kategorine Ait Ürümler</div>
